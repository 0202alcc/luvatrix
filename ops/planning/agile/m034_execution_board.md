...
## Intake
1. `T-2901` Menu crash hardening + safe dispatch contract.
2. `T-2902` Debug capability registry + menu ID standard.
3. `T-2903` Cross-platform menu adapter spec (macOS/Windows/Linux).
