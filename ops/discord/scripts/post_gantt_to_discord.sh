...
python "${REPO_ROOT}/ops/discord/scripts/generate_gantt_markdown.py" > /tmp/gantt_md_path.txt
MD_PATH=$(cat /tmp/gantt_md_path.txt)
python "${REPO_ROOT}/ops/discord/scripts/generate_gantt_png.py" > /tmp/gantt_path.txt
