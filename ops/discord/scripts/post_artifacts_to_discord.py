...
ARTIFACT_TO_CHANNEL = {
    ...
    "milestones_gantt.md": "milestones-gantt",
...
# Some planning artifacts now live outside ops/discord/artifacts.
ARTIFACT_ABSOLUTE_PATHS = {
    "milestones_gantt.md": "ops/planning/gantt/milestones_gantt.md",
    "agile_board_seed.md": "ops/planning/agile/agile_board_seed.md",
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--artifacts-dir", default="ops/discord/artifacts")
...
def main() -> int:
    ...
    for artifact_name, channel_name in ARTIFACT_TO_CHANNEL.items():
        artifact_path = Path(ARTIFACT_ABSOLUTE_PATHS.get(artifact_name, str(artifacts_dir / artifact_name)))
