...
def main() -> None:
    parser = argparse.ArgumentParser(description="Convert a TTF/OTF font into Luvatrix's Android bitmap glyph table.")
    ...
    args.out.write_text("\n".join(lines) + "\n", encoding="utf-8")
    print(f"wrote {args.out} ({len(lines) - 6} glyphs, {args.width}x{args.height}, advance={args.advance})")
