...
- `examples/planes_v2/input_sensor_overlay_logger/validation_artifact.json` with:
- `input_logged` == `True`
...
## Runnable command
`PYTHONPATH=. uv run python examples/planes_v2/input_sensor_overlay_logger/app_main.py --validate`

## Deterministic validation artifact reference
`examples/planes_v2/input_sensor_overlay_logger/validation_artifact.json`
