...
- `examples/planes_v2/multi_plane_layout/validation_artifact.json` with:
...
## Runnable command
`PYTHONPATH=. uv run python examples/planes_v2/multi_plane_layout/app_main.py --validate`

## Deterministic validation artifact reference
`examples/planes_v2/multi_plane_layout/validation_artifact.json`
