...
- `examples/planes_v2/coordinate_playground/validation_artifact.json` with:
...
## Runnable command
`PYTHONPATH=. uv run python examples/planes_v2/coordinate_playground/app_main.py --validate`

## Deterministic validation artifact reference
`examples/planes_v2/coordinate_playground/validation_artifact.json`
